...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.mnuOpen.Size = New System.Drawing.Size(111, 22)
        Me.mnuOpen.Text = "Open"
        '
        'mnuSave
        '
        Me.mnuSave.Name = "mnuSave"
        Me.mnuSave.Size = New System.Drawing.Size(111, 22)
        ...
        'fdOpen
        '
        Me.fdOpen.Filter = "Text Files(*.txt)|* .txt|All Files(*.*)|*.*"
        Me.fdOpen.InitialDirectory = "C:\Documents and Settings\David\My Documents"
        Me.fdOpen.Title = "Select File To Open"
        '
        'fdSave
        '
        Me.fdSave.CheckFileExists = True
        Me.fdSave.FileName = "Untitled"
        Me.fdSave.Filter = "Text File(*.txt)|.txt|All Files(*.*)|*.*"
        Me.fdSave.RestoreDirectory = True
